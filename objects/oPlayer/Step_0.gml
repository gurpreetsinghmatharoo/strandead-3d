...
iDir = point_direction(0, 0, -hor, -ver) + 90;
iSpd = abs(hor) || abs(ver);

hor = lengthdir_x(iSpd, -global.camYaw + iDir);
ver = lengthdir_y(iSpd, -global.camYaw + iDir);
